...
export default [
  ...
  },
  {
    ...
    component: ComponentCreator('/KafkaStarter/curriculum', 'd7c'),
    routes: [
      {
        path: '/KafkaStarter/curriculum',
        component: ComponentCreator('/KafkaStarter/curriculum', 'ebe'),
        routes: [
          {
            path: '/KafkaStarter/curriculum',
            component: ComponentCreator('/KafkaStarter/curriculum', 'a2c'),
            routes: [
              {
