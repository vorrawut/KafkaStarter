...
You've mastered the fan-out pattern for parallel processing! Next, learn about integrating Kafka with REST APIs in [Lesson 12: Kafka-Triggered REST & Command APIs](../lesson_12/concept.md), where you'll build hybrid architectures that combine event-driven and request-response patterns.
